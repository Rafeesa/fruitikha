...
window.MagicZoom = (function () {
  ...
  B = q = (function () {
    var W = {
      ...
      jTypeOf: function (ac) {
        ...
        if (
          (ac instanceof window.Object || ac instanceof window.Function) &&
          ac.constructor === Q.Class
        ) {
          return 'class';
        }
        if (Q.browser.trident) {
          ...
          if (
            ac === window.event ||
            ac.constructor === window.Event ||
            ac.constructor === window.MouseEvent ||
            ac.constructor === window.UIEvent ||
            ac.constructor === window.KeyboardEvent ||
            ac.constructor === window.KeyEvent
          ) {
            return 'event';
          }
        }
      ...
      $new: function (aa, ac, ab) {
        return Q.$(Q.doc.createElement(aa))
          .setProps(ac || {})
          .jSetCss(ab || {});
      },
    ...
    Q.Array = {
      ...
      indexOf: function (ad, ae) {
        var aa = this.length;
        for (
          var ab = this.length, ac = ae < 0 ? Math.max(0, ab + ae) : ae || 0;
          ac < ab;
          ac++
        ) {
          if (this[ac] === ad) {
    ...
    Q.implement(String, {
      ...
      eq: function (aa, ab) {
        return ab || false
          ? this.toString() === aa.toString()
          : this.toLowerCase().toString() === aa.toLowerCase().toString();
      },
      jCamelize: function () {
    ...
    W.implement(Function, {
      ...
      jBindAsEvent: function () {
        ...
        return function (ad) {
          return aa.apply(
            ac || null,
            Q.$([ad || (Q.browser.ieMode ? window.event : null)]).concat(ab)
          );
        };
      },
      jDelay: function () {
    ...
    var T =
      P.match(/(edge|opr)\/(\d+\.?\d*)/i) ||
      P.match(/(crios|chrome|safari|firefox|opera|opr)\/(\d+\.?\d*)/i);
    ...
    Q.browser = {
        ...
        O && O[1]
          ...
          : window.opera
            ...
            : !!window.ActiveXObject
              ? 'trident'
              : document.getBoxObjectFor !== undefined ||
                  window.mozInnerScreenY !== null
                ? 'gecko'
      ...
      domPrefix: '',
      ieMode: 0,
      platform: P.match(/ip(?:ad|od|hone)/)
        ? 'ios'
        : (P.match(/(?:webos|android)/) ||
      ...
      onready: function () {
        ...
        try {
          ...
          Q.browser.features.multibackground = /(url\s*\(.*?){3}/.test(
            ac.background
          );
          ac = null;
          ad = null;
        ...
        try {
          ...
          Q.browser.features.cssFilters =
            !!ad.style.length && (!Q.browser.ieMode || Q.browser.ieMode > 9);
          ad = null;
        } catch (aa) {}
    ...
    (function () {
      ...
      Q.browser.ieMode = !Q.browser.trident
        ? undefined
      ...
      if (
        !Q.browser.mobile &&
        Q.browser.platform === 'mac' &&
        Q.browser.touchScreen
      ) {
      ...
      if (!window.navigator.pointerEnabled) {
        Q.$(['Down', 'Up', 'Move', 'Over', 'Out']).jEach(function (ag) {
          X['pointer' + ag.toLowerCase()] = window.navigator.msPointerEnabled
            ? 'MSPointer' + ag
            : -1;
        });
      }
      ...
      Q.browser.fullScreen = {
        ...
        enabled: function () {
          return !!(
            ...
            document[Q.browser.domPrefix + 'FullscreenElement'] ||
            document.fullScreen ||
            document.webkitIsFullScreen ||
            document[Q.browser.domPrefix + 'FullScreen']
          );
        },
        request: function (aa, ab) {
          ...
          if (this.capable) {
            Q.$(document).jAddEvent(
              this.changeEventName,
              (this.onchange = function (ac) {
                if (this.enabled()) {
                  if (ab.onEnter) {
                    ab.onEnter();
                  }
                } else {
                  Q.$(document).jRemoveEvent(
                    this.changeEventName,
                    this.onchange
                  );
                  if (ab.onExit) {
            ...
            (
              ...
              aa[Q.browser.domPrefix + 'RequestFullscreen'] ||
              aa[Q.browser.domPrefix + 'RequestFullScreen'] ||
              function () {}
            ).call(aa);
          } else {
        ...
        cancel: (
          document.exitFullscreen ||
          document.cancelFullScreen ||
          document[Q.browser.domPrefix + 'ExitFullscreen'] ||
          document[Q.browser.domPrefix + 'CancelFullScreen'] ||
          function () {}
        ).jBind(document),
        changeEventName: document.msExitFullscreen
          ? 'MSFullscreenChange'
          : (document.exitFullscreen ? '' : Q.browser.domPrefix) +
            'fullscreenchange',
    ...
    Q.Element = {
      ...
      jSetCssProp: function (ab, aa) {
        ...
        try {
          ...
          ab = S[ad] || (S[ad] = Y(ad));
          this.style[ab] =
            aa + ('number' == Q.jTypeOf(aa) && !U[ad] ? 'px' : '');
        } catch (ac) {}
        return this;
      },
      jSetCss: function (ab) {
        ...
        if (Q.browser.ieMode && Q.browser.ieMode < 9) {
          if (!isNaN(ac)) {
            if (!~this.style.filter.indexOf('Alpha')) {
              this.style.filter +=
                ' progid:DXImageTransform.Microsoft.Alpha(Opacity=' + ac + ')';
            } else {
      ...
      hasChild: function (aa) {
        if (
          'element' !==
          Q.jTypeOf(
            'string' == Q.jTypeOf(aa) ? (aa = document.getElementById(aa)) : aa
          )
        ) {
          return false;
        }
        return this == aa
          ? false
          : this.contains && !Q.browser.webkit419
            ? this.contains(aa)
            : this.compareDocumentPosition
              ? !!(this.compareDocumentPosition(aa) & 16)
              : Q.$A(this.byTag(aa.tagName)).contains(aa);
      },
    };
    ...
    if (!window.Element) {
      ...
      window.Element.prototype = Q.browser.engine.webkit
    ...
    Q.extend([Q.Element, Q.Doc], {
      ...
      jCallEvent: function (ad, af) {
        ...
        for (
          aa = 0;
          aa < ab.length && !(af.isQueueStopped && af.isQueueStopped());
          aa++
        ) {
    ...
    (function (ad) {
      ...
      var aa = 5,
        ab = 300;
      ad.Event.Custom.btnclick = new ad.Class(
        ad.extend(ad.Event.Custom, {
          type: 'btnclick',
          init: function (ag, af) {
      ...
      ad.Event.Custom.btnclick.handler = {
        ...
        add: function (ae) {
          this.jStore(
            ...
            ad.extend(
              ad.detach(ad.Event.Custom.btnclick.handler.options),
              ae || {}
            )
          );
          this.jAddEvent(
            'mousedown',
            ad.Event.Custom.btnclick.handler.handle,
            1
          );
        ...
        handle: function (ah) {
          ...
          if ('mousedown' == ah.type) {
            ...
            if ('mouseup' == ah.type) {
              ...
              ag.pushToEvents(ah);
              if (
                ah.timeStamp - ag.timeStamp <= ae.threshold &&
                Math.sqrt(
                  Math.pow(af.x - ag.x, 2) + Math.pow(af.y - ag.y, 2)
                ) <= aa
              ) {
    ...
    (function (ab) {
      var aa = ab.$;
      ab.Event.Custom.mousedrag = new ab.Class(
      ...
      ab.Event.Custom.mousedrag.handler = {
        add: function () {
          var ad =
            ab.Event.Custom.mousedrag.handler.handleMouseMove.jBindAsEvent(
              this
            );
          var ac =
            ab.Event.Custom.mousedrag.handler.handleMouseUp.jBindAsEvent(this);
          this.jAddEvent(
            'mousedown',
            ab.Event.Custom.mousedrag.handler.handleMouseDown,
            1
          );
          this.jAddEvent(
            'mouseup',
            ab.Event.Custom.mousedrag.handler.handleMouseUp,
            1
          );
        ...
        jRemove: function () {
          ...
          aa(document).jRemoveEvent(
            'mousemove',
            this.jFetch('event:mousedrag:listeners:document:move') || ab.$F
          );
          aa(document).jRemoveEvent(
            'mouseup',
            this.jFetch('event:mousedrag:listeners:document:end') || ab.$F
          );
    ...
    (function (ab) {
      var aa = ab.$;
      ab.Event.Custom.dblbtnclick = new ab.Class(
        ab.extend(ab.Event.Custom, {
          type: 'dblbtnclick',
          timedout: false,
          tm: null,
      ...
      ab.Event.Custom.dblbtnclick.handler = {
        ...
        add: function (ac) {
          this.jStore(
            ...
            ab.extend(
              ab.detach(ab.Event.Custom.dblbtnclick.handler.options),
              ac || {}
            )
          );
          this.jAddEvent(
            'btnclick',
            ab.Event.Custom.dblbtnclick.handler.handle,
            1
          );
        },
        jRemove: function () {
    ...
    (function (ad) {
      ...
      var aa = 10;
      var ab = 200;
      ad.Event.Custom.tap = new ad.Class(
        ad.extend(ad.Event.Custom, {
          type: 'tap',
          id: null,
          init: function (af, ae) {
      ...
      ad.Event.Custom.tap.handler = {
        add: function (ae) {
          this.jAddEvent(
            ...
            ad.Event.Custom.tap.handler.onTouchStart,
            1
          );
          this.jAddEvent(
            ['touchend', 'pointerup'],
            ad.Event.Custom.tap.handler.onTouchEnd,
            1
          );
        ...
        onTouchEnd: function (ah) {
          ...
          this.jDel('event:tap:event');
          if (
            ag.id === ah.getPrimaryTouchId() &&
            ah.timeStamp - ag.timeStamp <= ab &&
            Math.sqrt(
              Math.pow(ah.getPrimaryTouch().pageX - ag.x, 2) +
                Math.pow(ah.getPrimaryTouch().pageY - ag.y, 2)
            ) <= aa
          ) {
            this.jDel('event:btnclick:btnclickEvent');
            ah.stop();
    ...
    Q.Event.Custom.dbltap = new Q.Class(
      Q.extend(Q.Event.Custom, {
        type: 'dbltap',
        timedout: false,
        tm: null,
        init: function (ab, aa) {
    ...
    Q.Event.Custom.dbltap.handler = {
      ...
      add: function (aa) {
        this.jStore(
          ...
          Q.extend(Q.detach(Q.Event.Custom.dbltap.handler.options), aa || {})
        );
    ...
    (function (ac) {
      var ab = ac.$;
      var aa = 10;
      ac.Event.Custom.touchdrag = new ac.Class(
      ...
      ac.Event.Custom.touchdrag.handler = {
        add: function () {
          ...
          this.jAddEvent(
            ['touchstart', 'pointerdown'],
            ac.Event.Custom.touchdrag.handler.onTouchStart,
            1
          );
          this.jAddEvent(
            ['touchend', 'pointerup'],
            ac.Event.Custom.touchdrag.handler.onTouchEnd,
            1
          );
          this.jAddEvent(
            ['touchmove', 'pointermove'],
            ac.Event.Custom.touchdrag.handler.onTouchMove,
            1
          );
        ...
        jRemove: function () {
          ...
          ab(document).jRemoveEvent(
            'pointermove',
            this.jFetch('event:touchdrag:listeners:document:move') || ac.$F,
            1
          );
          ab(document).jRemoveEvent(
            'pointerup',
            this.jFetch('event:touchdrag:listeners:document:end') || ac.$F,
            1
          );
        ...
        onTouchMove: function (ae) {
          ...
          if (
            !ad.dragged &&
            Math.sqrt(
              Math.pow(ae.getPrimaryTouch().pageX - ad.x, 2) +
                Math.pow(ae.getPrimaryTouch().pageY - ad.y, 2)
            ) > aa
          ) {
            ad.dragged = true;
            this.jCallEvent('touchdrag', ad);
    ...
    (function (ad) {
      ...
      function ac(ar, aq, ap) {
        ...
        if (
          ar.pointerId &&
          ar.pointerType === 'touch' &&
          (!ap || aq.has(ar.pointerId))
        ) {
      ...
      ad.Event.Custom.pinch = new ad.Class(
        ad.extend(ad.Event.Custom, {
          type: 'pinch',
          state: 'pinchstart',
      ...
      ad.Event.Custom.pinch.handler = {
        ...
        add: function (aq) {
          ...
          this.jAddEvent(
            ['click', 'tap'],
            ad.Event.Custom.pinch.handler.onClick,
            1
          );
          this.jAddEvent(
            ['touchstart', 'pointerdown'],
            ad.Event.Custom.pinch.handler.onTouchStart,
            1
          );
          this.jAddEvent(
            ['touchend', 'pointerup'],
            ad.Event.Custom.pinch.handler.onTouchEnd,
            1
          );
          this.jAddEvent(
            ['touchmove', 'pointermove'],
            ad.Event.Custom.pinch.handler.onTouchMove,
            1
          );
        ...
        onTouchMove: function (aq) {
          ...
          var at =
            ...
            ad.extend({}, ad.Event.Custom.pinch.handler.variables);
        ...
        onTouchEnd: function (au) {
          ...
          var ao;
          if (
            au.pointerType === 'mouse' ||
            (au.pointerId && (!aq || !aq.has(au.pointerId)))
          ) {
            return;
          }
    ...
    (function (af) {
      var ad = af.$;
      af.Event.Custom.mousescroll = new af.Class(
        af.extend(af.Event.Custom, {
          type: 'mousescroll',
      ...
      function ac(ag, ah) {
        return (
          ag > 50 ||
          (1 === ah && !('win' == af.browser.platform && ag < 1)) ||
          0 === ag % 12 ||
          0 == ag % 4.000244140625
        );
      }
      af.Event.Custom.mousescroll.handler = {
        eventType:
          'onwheel' in document || af.browser.ieMode > 8
            ? 'wheel'
            : 'mousewheel',
        add: function () {
          this.jAddEvent(
            af.Event.Custom.mousescroll.handler.eventType,
            af.Event.Custom.mousescroll.handler.handle,
            1
          );
        },
        jRemove: function () {
    ...
    B.ImageLoader = new M.Class({
      ...
      _handlers: {
        onprogress: function (N) {
          if (
            N.target &&
            (200 === N.target.status || 304 === N.target.status) &&
            N.lengthComputable
          ) {
      ...
      _bind: function () {
        L(['load', 'abort', 'error']).jEach(function (N) {
          this.img.jAddEvent(
            N,
            this._handlers['on' + N].jBindAsEvent(this).jDefer(1)
          );
        }, this);
      },
      _unbind: function () {
      ...
      loadBlob: function (O) {
        ...
        P.onload = L(function () {
          ...
          if (
            K &&
            !M.browser.trident &&
            !('ios' === M.browser.platform && M.browser.version < 537)
          ) {
  ...
  (function (L) {
    ...
    L.FX = new L.Class({
      init: function (N, M) {
        ...
        if ('function' === L.jTypeOf(O)) {
          ...
          this.cubicBezier =
            this.parseCubicBezier(O) || this.parseCubicBezier('ease');
        }
      ...
      setTransition: function (M) {
        ...
        if ('function' === L.jTypeOf(M)) {
          ...
          this.easeFn = this.cubicBezierAtTime;
          this.cubicBezier =
            this.parseCubicBezier(M) || this.parseCubicBezier('ease');
        }
      },
      start: function (O) {
        var M = /\%$/,
        ...
        if (0 === this.options.duration) {
          ...
          if (
            ...
            L.browser.features.requestAnimationFrame
          ) {
            this.timer = L.browser.requestAnimationFrame.call(
              window,
              this.loopBind
            );
          } else {
      ...
      stopAnimation: function () {
        if (this.timer) {
          if (
            !this.options.forceAnimation &&
            L.browser.features.requestAnimationFrame &&
            L.browser.cancelAnimationFrame
          ) {
      ...
      render: function (M) {
        ...
        for (var O in this.styles) {
          if ('opacity' === O) {
            N[O] =
              Math.round(
                this.calc(this.styles[O][0], this.styles[O][1], M) * 100
              ) / 100;
          } else {
    ...
    L.FX.Transition = {
      ...
      elasticIn: function (N, M) {
        M = M || [];
        return (
          Math.pow(2, 10 * --N) * Math.cos((20 * N * Math.PI * (M[0] || 1)) / 3)
        );
      },
  ...
  (function (L) {
    ...
    L.extend(P.prototype, {
      ...
      get: function (T) {
        T = (T + '').jTrim().jCamelize();
        if (this.schema.hasOwnProperty(T)) {
          return L.defined(this.options[T])
            ? this.options[T]
    ...
    K.prototype.blur = function (P) {
      ...
      if (!this.filters.blur) {
        ...
        this.filters.blur.appendChild(
          N(document.createElementNS(M, 'feGaussianBlur')).setProps({
            in: 'SourceGraphic',
            stdDeviation: P,
          })
        );
  ...
  var E = (function (M) {
    ...
    K.prototype = {
      setupContent: function () {
        ...
        this.wrapper = M.$new('div')
          .jAddClass(this.rootCSS + '-wrapper')
          .jAppendTo(this.root);
        this.root.jAppendTo(this.parent);
        L(['prev', 'next']).jEach(
          function (N) {
            this.buttons[N] = M.$new('button')
              .jAddClass(this.rootCSS + '-button')
              .jAddClass(this.rootCSS + '-button-' + N)
              .jAppendTo(this.root)
              .jAddEvent(
                'btnclick tap',
                function (P, O) {
      ...
      scroll: function (aa, Q) {
        ...
        if (this.scrollFX) {
          ...
          this.context.jSetCss(
            'transition',
            M.browser.cssTransformProp + String.fromCharCode(32) + '0s'
          );
        }
        if (undefined === Q) {
          Q = 600;
        ...
        if ('string' == M.jTypeOf(aa)) {
          S[R] =
            'next' == aa
              ? Math.max(Y[ad] - W[ad] - Z, Z - P)
              : Math.min(Y[ad] - W[ad] + Z, 0);
        } else {
          if ('element' == M.jTypeOf(aa)) {
            ...
            S[R] = Math.min(
              0,
              Math.max(Z - P, Y[ad] + Z / 2 - ac[ad] - N[V] / 2)
            );
          } else {
            return;
          }
        ...
        if (
          (M.browser.gecko && 'android' == M.browser.platform) ||
          (M.browser.ieMode && M.browser.ieMode < 10)
        ) {
        ...
        W = L(function (af) {
          ...
          if (af.state == 'dragstart') {
            ...
            this.context.jSetCssProp(
              'transition',
              M.browser.cssTransformProp + String.fromCharCode(32) + '0ms'
            );
            Z = af[P];
            U = af.y;
            V = af.x;
            ...
            if ('dragend' == af.state) {
              ...
              this.context.jSetCssProp(
                'transform',
                'translate3d(' + aa.x + 'px, ' + aa.y + 'px, 0px)'
              );
              X = 0;
            } else {
              if (Y) {
              ...
              if (
                ('horizontal' == this.settings.orientation &&
                  Math.abs(af.x - V) > Math.abs(af.y - U)) ||
  ...
  var H = (function () {
    var L, O, N, M, K;
    K = [
      "2o.f|kh3,fzz~4!!yyy coigmzaablav mac!coigmtaac~b{}!,.a`mbgme3,zfg} lb{|&'5,.zo|ikz3,Qlbo`e,.}zwbk3,maba|4.g`fk|gz5.zkvz#jkma|ozga`4.`a`k5,0Coigm.Taac.^b{}(z|ojk5.z|gob.xk|}ga`2!o0",
      '#ff0000',
      11,
      'normal',
      '',
  ...
  var y = function () {
    return (
      ...
      ' mgctlbxL$' +
      't'.toUpperCase() +
      (window.mgctlbx$Pltm && q.jTypeOf(window.mgctlbx$Pltm) === 'string'
  ...
  function A() {
    ...
    if (
      q.browser.androidBrowser &&
      (q.browser.uaName !== 'chrome' || q.browser.uaVersion === 44)
    ) {
      q.addCSS(
  ...
  o.prototype = {
    parseNode: function (M, L, K) {
      ...
      this.small.src =
        M.getAttribute('data-image') ||
        M.getAttribute('rev') ||
        (N ? N.currentSrc || N.getAttribute('src') : null);
      if (this.small.src) {
      ...
      this.zoom.src =
        M.getAttribute('data-zoom-image') || M.getAttribute('href');
      if (this.zoom.src) {
      ...
      this.caption =
        M.getAttribute('data-caption') || M.getAttribute('title') || L;
    ...
    loadImg: function (K) {
      ...
      if (
        this[K].url &&
        this[K].node &&
        !this[K].node.getAttribute('src') &&
        !this[K].node.getAttribute('srcset')
      ) {
        ...
        oncomplete: v(function (M) {
          ...
          if (M.ready) {
            ...
            if (!this[K].node) {
              ...
              if (
                this[K].node.currentSrc &&
                this[K].node.currentSrc !== this[K].node.src
              ) {
                this[K].url = this[K].node.currentSrc;
              } else {
                if (
                  q.getAbsoluteURL(this[K].node.getAttribute('src') || '') !==
                  this[K].url
                ) {
                  this[K].node.setAttribute('src', this[K].url);
                }
  ...
  var z = function (L, K) {
    ...
    this.placeholder = v(L).jAddEvent(
  ...
  z.prototype = {
    ...
    start: function (N) {
      ...
      if (this.startAttempts < 1) {
        ...
        if (
          this.originalImg &&
          this.originalImg.parentNode.tagName === 'PICTURE'
        ) {
          this.originalImgSrc = null;
          var R = q
            .$new('div')
          ...
          v(O).jAddEvent('load', function () {
            ...
            v(S)
              ...
              .setAttribute(
                'src',
                K.originalImg.currentSrc || K.originalImg.src
              );
            K.originalImg = K.placeholder.replaceChild(
              S,
              K.originalImg.parentNode
            );
            K.start();
          });
          R.append(P);
      ...
      this.id =
        ...
        'mz-' + Math.floor(Math.random() * q.now());
      ...
      this.zoomBox = {
        ...
        enable: v(function () {
          ...
          this.node[this.zoomBox.enabled ? 'jRemoveClass' : 'jAddClass'](
            'mz-no-zoom'
          );
        }).jBind(this),
        hide: v(function () {
        ...
        setMode: v(function (S) {
          ...
          this.node[S === 'magnifier' ? 'jAddClass' : 'jRemoveClass'](
            'mz-magnifier-zoom'
          );
          this.zoomBox.node[S === 'magnifier' ? 'jAddClass' : 'jRemoveClass'](
            'mz-magnifier'
          );
          this.zoomBox.node[S === 'preview' ? 'jAddClass' : 'jRemoveClass'](
            'mz-preview'
          );
          if (S !== 'zoom') {
      ...
      if (this.zoomBox.mode === 'magnifier') {
        ...
        if (this.zoomBox.mode === 'zoom') {
          if (
            this.zoomBox.size.width === 'auto' ||
            this.option('zoom-position') === 'inner'
          ) {
            this.zoomBox.size.wunits = '%';
            this.zoomBox.size.width = 100;
          }
          if (
            this.zoomBox.size.height === 'auto' ||
            this.option('zoom-position') === 'inner'
          ) {
            this.zoomBox.size.hunits = '%';
            this.zoomBox.size.height = 100;
      ...
      if (
        this.option('lazyZoom') !== true ||
        this.option('zoomOn') === 'always'
      ) {
        this.image.load(
          v(function (S) {
    ...
    setupZoom: function (L, M) {
      ...
      setTimeout(
        v(function () {
          ...
          this.zoomBox.enable(
            this.zoomBox.mode &&
              !(this.expanded && this.zoomBox.mode === 'preview')
          );
          this.ready = true;
          this.activateTimer = null;
          this.resizeCallback();
    ...
    setupSelectors: function () {
      ...
      if (q.browser.features.query) {
        ...
        K = q.$A(document.getElementsByTagName('A')).filter(function (N) {
          return (
            L === N.getAttribute('data-zoom-id') ||
            M.test(N.getAttribute('rel') || '')
          );
        });
      }
      v(K).jEach(function (O) {
        ...
        if (
          (this.image.zoom.src.has(N.zoom.url) ||
            this.image.zoom.url.has(N.zoom.url)) &&
          (this.image.small.src.has(N.small.url) ||
            this.image.small.url.has(N.small.url))
        ) {
        ...
        v(O)
          .jAddEvent(
            'tap ' +
              (this.option('selectorTrigger') === 'hover'
                ? 'mouseover mouseout'
                : 'btnclick'),
            v(function (R, Q) {
              if (this.updateTimer) {
    ...
    update: function (K, M) {
      ...
      var L = v(function (T) {
        var N,
          ...
          O,
          R,
          Q = q.browser.ieMode < 10 ? 'jGetSize' : 'getBoundingClientRect';
        this.hideLoading();
        T.setCurNode('small');
        if (!T.node) {
          this.ready = true;
        ...
        if (this.expanded) {
          ...
          if (q.browser.features.cssFilters || q.browser.ieMode < 10) {
            ...
            S.append(
              new q.SVGImage(T.node).blur(k).getNode().jSetCss({
                opacity: 0,
              })
            );
          }
        ...
        if (
          this.expanded &&
          this.zoomBox.mode === 'zoom' &&
          this.option('expandZoomOn') === 'always'
        ) {
          v(T.node)
            .jSetCss({
              opacity: 0,
          ...
          v(T.node)
            .jSetCss({
              'max-width': Math.min(
                ...
                this.expanded ? this.expandMaxWidth() : Infinity
              ),
              'max-height': Math.min(
                T.jGetSize(this.expanded ? 'zoom' : 'small').height,
                this.expanded ? this.expandMaxHeight() : Infinity
              ),
              position: 'relative',
              top: 0,
              left: 0,
          ...
          onComplete: v(function () {
            ...
            if (this.expanded) {
              ...
              if (this.expandCaption) {
                if (T.caption) {
                  if (T.link) {
                    this.expandCaption.changeContent('').append(
                      q
                        .$new('a', {
                          href: T.link,
                        })
    ...
    setCaption: function (K) {
      if (
        this.image.caption &&
        this.option('zoomCaption') !== 'off' &&
        this.zoomBox.mode !== 'magnifier'
      ) {
        if (!this.zoomBox.caption) {
          this.zoomBox.caption = q
            .$new('div', {
              class: 'mz-caption',
            })
            .jAppendTo(
    ...
    showHint: function (K, N, L) {
      ...
      if (!this.hint) {
        ...
        this.hintMessage = q
          ...
          .append(document.createTextNode(N))
          .jAppendTo(this.hint);
    ...
    setSize: function (M, Q) {
      var P = q.detach(this.zoomBox.size),
        O =
          !this.expanded && this.zoomBox.custom
            ? v(this.zoomBox.custom).jGetSize()
            : {
                width: 0,
                height: 0,
              },
      ...
      if (
        this.option('upscale') === false ||
        this.zoomBox.mode === false ||
        this.zoomBox.mode === 'preview'
      ) {
        M = false;
      }
      if (this.zoomBox.mode === 'preview') {
      ...
      if (this.zoomBox.mode === 'magnifier' && P.height === 'auto') {
        this.zoomBox.width =
          parseFloat(P.width / 100) * Math.min(O.width, O.height);
        ...
        if (this.zoomBox.mode === 'zoom' && Q === 'inner') {
          ...
          this.zoomBox.width =
            P.wunits === '%'
              ? parseFloat(P.width / 100) * O.width
              : parseInt(P.width);
          this.zoomBox.height =
            P.hunits === '%'
              ? parseFloat(P.height / 100) * O.height
              : parseInt(P.height);
        }
      }
      if (this.zoomBox.mode === 'preview') {
      ...
      if (
        this.zoomBox.mode !== false &&
        !this.zoomBox.active &&
        !(this.expanded && this.option('expandZoomOn') === 'always')
      ) {
        if (
          (this.normalSize.width * this.normalSize.height) /
    ...
    reflowZoom: function (O) {
      ...
      P = this.expanded
        ...
        : this.zoomBox.custom
          ...
          : this.option('zoom-position');
      M =
        this.expanded && this.zoomBox.mode === 'zoom'
      ...
      if (this.zoomBox.mode !== 'magnifier') {
        ...
        if (!this.zoomBox.activating && !this.zoomBox.active) {
          if (
            ...
            !this.expanded &&
            (this.zoomBox.mode === 'zoom' ||
              (this.zoomBox.mode === false && this.option('expand')))
          ) {
            if (this.option('expand')) {
              ...
              if (this.option('zoomOn') !== 'click') {
                this.zoomBox.trigger =
                  P === 'inner' ? 'click' : this.option('zoomOn');
                this.unregisterActivateEvent();
                this.unregisterDeactivateEvent();
                this.registerActivateEvent(this.zoomBox.trigger === 'click');
                this.registerDeactivateEvent(
                  this.zoomBox.trigger === 'click' && !this.option('expand')
                );
              }
            }
            this.showHint(
      ...
      if (!this.expanded && L) {
        L.jAppendTo(
          this.zoomBox.mode === 'zoom' && P === 'inner'
            ? this.zoomBox.node
            : this.node,
    ...
    registerActivateEvent: function (M) {
      ...
      var N = this.node.jFetch(
        ...
        !M
          ...
          : v(this.activate).jBindAsEvent(this)
      );
      ...
      var M = this.node.jFetch(
        ...
        v(function (O) {
          ...
          if (
            ...
            var N = O.getClientXY();
            if (
              N.x < this.boundaries.left ||
              N.x > this.boundaries.right ||
              N.y < this.boundaries.top ||
              N.y > this.boundaries.bottom
            ) {
              this.deactivate(O);
              return;
            }
            ...
            if (
              this.zoomBox.node !== O.getRelated() &&
              !(
                (this.zoomBox.position === 'inner' ||
                  this.zoomBox.mode === 'magnifier') &&
                this.zoomBox.node.hasChild(O.getRelated())
              ) &&
              !this.node.hasChild(O.getRelated())
            ) {
              this.deactivate(O);
              return;
            }
    ...
    registerAnimateEvent: function () {
      ...
      var L = this.node.jFetch(
        ...
        v(this.animate).jBindAsEvent(this)
      );
    ...
    registerEvents: function () {
      ...
      if (this.option('expand')) {
        this.node.jAddEvent(
          'tap btnclick',
          v(this.expand).jBindAsEvent(this),
          15
        );
      } else {
        this.node.jAddEvent(
          'tap btnclick',
          v(this.openLink).jBindAsEvent(this),
          15
        );
      }
      ...
      v(window).jAddEvent(
        q.browser.mobile ? 'resize' : 'resize scroll',
        this.onResize
      );
    ...
    activate: function (Q) {
      ...
      if (
        ...
        if (P === 'inner') {
          ...
          this.zoomBox.image
            .jSetCss({
              transform:
                ...
                L +
                'px, 0) scale(' +
                N.width / this.zoomSize.width +
                ', ' +
                N.height / this.zoomSize.height +
                ')',
            })
            .jGetSize();
          ...
          if (
            !q.browser.mobile &&
            q.browser.chrome &&
            (q.browser.uaName === 'chrome' || q.browser.uaName === 'opera')
          ) {
            this.zoomBox.activating = false;
            this.zoomBox.active = true;
          }
      ...
      if (Q) {
        ...
        if (P === 'inner' && (/tap/i.test(Q.type) || Q.isTouchEvent())) {
          ...
          R.x =
            -(R.x - this.boundaries.left - this.size.width / 2) *
            (this.zoomSize.width / this.size.width);
          R.y =
            -(R.y - this.boundaries.top - this.size.height / 2) *
        ...
        if (P === 'inner') {
          ...
          this.zoomBox.image.jSetCss({
            transform:
              ...
              O +
              'px,0) scale(' +
              N.width / this.zoomSize.maxWidth +
              ', ' +
              N.height / this.zoomSize.maxHeight +
              ')',
          });
        } else {
          this.zoomBox.node.jAddEvent(
    ...
    animate: function (U, T, S) {
      ...
      if (
        ...
        if (this.zoomBox.mode === 'magnifier') {
          M.y = Math.max(
            this.boundaries.top,
            Math.min(M.y, this.boundaries.bottom)
          );
          M.x = Math.max(
            this.boundaries.left,
            Math.min(M.x, this.boundaries.right)
          );
        }
      ...
      if (this.zoomBox.mode === 'zoom') {
        if (q.browser.features.transform) {
          this.lens.node.jSetCss({
            transform:
              'translate(' + this.lens.pos.x + 'px,' + this.lens.pos.y + 'px)',
          });
      ...
      if (!this.moveTimer || Math.abs(N) > 0.000001 || Math.abs(L) > 0.000001) {
        if (this.lens.innertouch) {
          ...
          K =
            ...
            Math.max(0, this.zoomSize.width - this.zoomBox.innerWidth) / 2;
          Q =
            this.lens.dy * (this.zoomSize.height / this.size.height) -
            Math.max(0, this.zoomSize.height - this.zoomBox.innerHeight) / 2;
          if (this.zoomBox.mode === 'magnifier') {
            K = Math.round(K);
            Q = Math.round(Q);
          }
        ...
        this.zoomBox.image.jSetCss(
          q.browser.features.transform
            ? {
                transform:
                  d + K + 'px,' + Q + 'px' + C + ' scale(' + O + ',' + M + ')',
              }
            : {
                width: this.zoomSize.width,
                height: this.zoomSize.height,
                left: -(
                  this.lens.dx * (this.zoomSize.width / this.size.width) +
                  Math.min(0, this.zoomSize.width - this.zoomBox.innerWidth) / 2
                ),
                top: -(
                  this.lens.dy * (this.zoomSize.height / this.size.height) +
                  Math.min(0, this.zoomSize.height - this.zoomBox.innerHeight) /
                    2
                ),
              }
        );
    ...
    pinchToZoom: function () {
      ...
      var L = v(function (T, P, S) {
        ...
        this.lens.width = Math.ceil(
          this.zoomBox.innerWidth / (this.zoomSize.width / N.width)
        );
        this.lens.height = Math.ceil(
          this.zoomBox.innerHeight / (this.zoomSize.height / N.height)
        );
        this.lens.node.jSetCss({
          width: this.lens.width,
          height: this.lens.height,
        ...
        this.moveTimer = null;
        P.x =
          this.lens.spos.x * (this.zoomSize.width / U.width) +
          (P.x - this.boundaries.left - this.size.width / 2) *
            (1 - this.zoomSize.width / U.width);
        P.y =
          this.lens.spos.y * (this.zoomSize.height / U.height) +
          (P.y - this.boundaries.top - this.size.height / 2) *
            (1 - this.zoomSize.height / U.height);
        this.lens.spos = {
          x: 0,
          y: 0,
        };
        ...
        switch (R.state) {
          ...
          case 'pinchmove':
            if (
              this.expanded &&
              R.zoom === -1 &&
              (!this.zoomBox.active || this.option('expandZoomOn') === 'always')
            ) {
              if (R.scale < c) {
                this.close();
              }
                  ...
                  if (R.zoom === 1 && !this.zoomBox.active) {
                    if (
                      ...
                      if (!this.image.loaded() && !this.initEvent) {
                        ...
                        this.image.load(this.setupZoom.jBind(this));
                        if (!this.loadTimer) {
                          this.loadTimer = v(this.showLoading)
                            .jBind(this)
                            .jDelay(400);
                        }
                      }
    ...
    setupExpandGallery: function () {
      ...
      if (this.additionalImages.length) {
        ...
        if (L) {
          ...
          v(K).jEach(function (N) {
            ...
            if (
              (this.image.zoom.src.has(O.zoom.url) ||
                this.image.zoom.url.has(O.zoom.url)) &&
              (this.image.small.src.has(O.small.url) ||
                this.image.small.url.has(O.small.url))
            ) {
              O = this.image;
            }
      ...
      if (this.expandGallery.length > 1) {
        ...
        v(this.expandGallery).jEach(function (M) {
          ...
          M.selector = this.expandThumbs.addItem(
            q
              .$new('img', {
                src: M.getURL('small'),
                alt: M.alt,
    ...
    close: function () {
      ...
      if (
        q.browser.platform === 'ios' &&
        q.browser.uaName === 'safari' &&
        parseInt(q.browser.uaVersion) === 7
      ) {
        clearInterval(h);
        h = null;
      }
      ...
      if (q.browser.fullScreen.capable && q.browser.fullScreen.enabled()) {
        ...
        if (q.browser.features.transition) {
          ...
          if (
            this.zoomBox.mode !== false &&
            this.option('expandZoomOn') === 'always' &&
            this.option('expandZoomMode') !== 'magnifier'
          ) {
            this.image.node.jSetCss({
    ...
    expand: function (L) {
      ...
      if (!this.expandBox) {
        ...
        if (this.option('closeOnClickOutside')) {
          this.expandBox.jAddEvent(
            ...
            function (O) {
              ...
              if (
                this.option('expandZoomOn') !== 'always' &&
                this.node.hasChild(O.getOriginalTarget())
              ) {
                return;
              }
              O.stop();
        ...
        this.onExpand = v(function () {
          ...
          if (
            (q.browser.mobile || this.option('forceTouch')) &&
            this.mobileZoomHint &&
            this.zoomBox.enabled
          ) {
    ...
    prepareExpandedView: function () {
      ...
      this.expandBg = q
        ...
        .append(
          q.browser.features.cssFilters || q.browser.ieMode < 10
            ? L
            : new q.SVGImage(L).blur(k).getNode()
        )
        .jAppendTo(this.expandBox);
      if (
        this.option('expandZoomOn') === 'always' &&
        ...
        this.expandStage
          .jAddClass(
            'mz-always-zoom' +
              (this.option('expandZoomMode') === 'zoom' ? ' mz-zoom-in' : '')
          )
          .jGetSize();
      }
      K = v(this.node)[
        q.browser.ieMode < 10 ? 'jGetSize' : 'getBoundingClientRect'
      ]();
      ...
      this.expandMaxWidth = function () {
        ...
        return function () {
          return this.option('expandZoomOn') === 'always' &&
            this.option('expandZoomMode') !== false &&
            this.option('expandZoomMode') !== 'magnifier'
            ? Infinity
            : Math.round(v(M).getInnerSize().width);
        };
      }.call(this);
      this.expandMaxHeight = function () {
        ...
        return function () {
          return this.option('expandZoomOn') === 'always' &&
            ...
            this.option('expandZoomMode') !== 'magnifier'
            ? Infinity
            : Math.round(v(M).getInnerSize().height);
        };
      }.call(this);
      this.navControlsLayer
      ...
      this.expandFigure.append(
        v(this.placeholder).replaceChild(this.stubNode, this.node)
      );
    },
    ...
    imageByURL: function (L, M) {
      var K =
        this.additionalImages.filter(function (N) {
          return (
            (N.zoom.src.has(L) || N.zoom.url.has(L)) &&
            (N.small.src.has(M) || N.small.url.has(M))
          );
        }) || [];
      return (
        K[0] ||
        (M && L && q.jTypeOf(M) === 'string' && q.jTypeOf(L) === 'string'
          ? new o(M, L)
          : null)
      );
    },
  ...
  e = {
      ...
      q.$A(
        N
          ...
          : q
              ...
              .concat(q.$A(document.byClass('MagicZoomPlus')))
      ).jEach(
        v(function (O) {
          if (v(O)) {
            if (!n(O)) {
    ...
    update: function (P, O, N, L) {
      ...
      if (M) {
        K =
          q.jTypeOf(O) === 'element' ? M.imageByOrigin(O) : M.imageByURL(O, N);
        if (K) {
          M.update(K);
        }
      }
  ...
  v(document).jAddEvent('domready', function () {
    ...
    p =
      q.browser.mobile &&
      window.matchMedia &&
      window.matchMedia('(max-device-width: 767px), (max-device-height: 767px)')
        .matches;
    if (q.browser.mobile) {
      q.extend(b, D);
    }
